...
uses
  ...
  Projeto.View.uInterfaces, Projeto.Model.Dto.UPokemon,
  Projeto.Repository.UPokemonRepository, System.Generics.Collections,
...
uses
  Projeto.Repository.UImagemRepository;
